...
import {getMonthRows, getYearList} from '../utils/date-utils';
...
const TITLE_FORMAT = DEFAULT_TITLE_FORMAT.month;

export function createMonthPanel(
    ...
    function getSelectedValueTimestamp() {
        ...
        return value && value.startOf('month').valueOf();
    }
...
export type TypeModuleMonthPanel = ReturnType<typeof createMonthPanel>
