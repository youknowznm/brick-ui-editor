...
function updateI18n(id, value, lang, module, force) {
    ...
    var commonFile = npath.join(config.path.extraFrontendAsset, 'i18n', lang, 'common.js')
    var moduleFile = npath.join(config.path.extraFrontendAsset, 'i18n', lang, module + '.js')
...
function getI18n(id, lang, module) {
    ...
    if (fs.existsSync(moduleFile)) {
        return getValue(moduleFile, id)
    }
    if (fs.existsSync(commonFile)) {
        return getValue(commonFile, id)
    }
    return null
}
