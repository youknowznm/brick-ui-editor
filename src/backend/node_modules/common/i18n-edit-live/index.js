...
function indexMiddleware(req, res) {
    res.write('current: ' + npath.join(req.baseUrl, req.url) + '\n')
    res.write('auth: ' + npath.join(req.baseUrl, 'auth') + '\n')
    res.write('update: ' + npath.join(req.baseUrl, 'update') + '\n')
    res.write('get: ' + npath.join(req.baseUrl, 'get') + '\n')
    res.end()
}
